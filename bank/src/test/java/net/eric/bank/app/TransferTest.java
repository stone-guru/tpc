...
public class TransferTest {
    ...
    public static final InetSocketAddress PEER2 = new InetSocketAddress("192.168.1.101", 10022);
    
    public static final String JDBC_URL = "jdbc:h2:/home/bison/workspace/tpc/deploy/database/data_abc";
    ...
    public static void main(String[] args) throws Exception {
        ...
        bill.setAmount(BigDecimal.valueOf(970));
    ...
    public static TransactionManager<TransferBill> getTm(){
        ...
        NightWatch.regCloseable("trans action manager", tm);
        return tm;
    }
